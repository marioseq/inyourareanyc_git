...
class PLauthorplus extends PageLinesSection {
	...
	function section_optionator( $settings ){
		...
		$option_array = array(
				...
				'authorplus_social' => array(
						'type'		=> 'check_multi',
						'selectvalues'	=> array(
							'auth_rsslink'	=> array('inputlabel'=> __( 'RSS', 'pagelines' )),
							'auth_share_twitter'		=> array('inputlabel'=> __( 'Twitter', 'pagelines' )),
							'auth_share_facebook'	=> array('inputlabel'=> __( 'Facebook', 'pagelines' )),
							'auth_share_google'		=> array('inputlabel'=> __( 'Google+', 'pagelines' )),
							'auth_share_linkedin'	=> array('inputlabel'=> __( 'LinkedIn', 'pagelines' )),
							'auth_share_pinterest'	=> array('inputlabel'=> __( 'Pinterest', 'pagelines' )),
						),
			    ...
			    'authorplus_social_links' => array(
			    	...
			    	'selectvalues' => array(
			    		...
			    		'auth_twitter_link' => array(
			    			'type'   => 'text',
			    			'inputlabel' => 'Twitter',
			    		),
			    		'auth_facebook_link' => array(
			    			'type'   => 'text',
			    			'inputlabel' => 'Facebook',
			    		),
			    		'auth_google_link' => array(
			    			'type'   => 'text',
			    			'inputlabel' => 'Google Plus',
			    		),
			    		'auth_linkedin_link' => array(
			    			'type'   => 'text',
			    			'inputlabel' => 'LinkedIn',
			    		),
			    		'auth_pinterest_link' => array(
			    			'type'   => 'text',
			    			'inputlabel' => 'Pinterest',
			    		),
			    	),
					'title'		=> __( 'Author Plus Social Network Profiles', 'pagelines' ),						
					'shortexp'	=> __( 'Enter social network profile URL', 'pagelines' ),
					'exp'		=> __( "Enter the full URL to your social network profiles", 'pagelines' )
			    ),					
		);
   ...
   function section_template( $clone_id ) { 
		...
		$share_twitter = ploption('auth_share_twitter',$this->oset);
						  		...
						  		<?php
									...
									printf('<div class="authorplusicons">');
											...
											pagelines_register_hook( 'pagelines_authorplus_icons_start', 'authorplus' ); // Hook 
												...
												if(ploption('auth_rsslink'))
													printf('<a target="_blank" href="%s" class="author_rss"><img src="%s" alt="Twitter"/></a>', ploption('auth_rss_link',$this->oset), $this->base_url.'/rss.png');

												if($share_twitter)
													printf('<a target="_blank" href="%s" class="twitterlink"><img src="%s" alt="Twitter"/></a>', ploption('auth_twitter_link',$this->oset), $this->base_url.'/twitter.png');
											
												if(ploption('auth_share_facebook'))
													printf('<a target="_blank" href="%s" class="facebooklink"><img src="%s" alt="Facebook"/></a>', ploption('auth_facebook_link',$this->oset), $this->base_url.'/facebook.png');
												
												if(ploption('auth_share_linkedin'))
													printf('<a target="_blank" href="%s" class="linkedinlink"><img src="%s" alt="LinkedIn"/></a>', ploption('auth_linkedin_link',$this->oset), $this->base_url.'/linkedin.png');
												
												if(ploption('auth_share_pinterest'))
													printf('<a target="_blank" href="%s" class="pinterest"><img src="%s" alt="Pinterest"/></a>', ploption('auth_pinterest_link',$this->oset), $this->base_url.'/pinterest.png');
												
												if(ploption('auth_share_google'))
													printf('<a target="_blank" href="%s" class="gpluslink"><img src="%s" alt="Google+"/></a>', ploption('auth_google_link',$this->oset), $this->base_url.'/google.png');
