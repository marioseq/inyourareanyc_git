...
class DZSVideoGallery {
    ...
    function __construct() {
        ...
        if ($this->mainitems == '') {
            $aux = 'a:1:{i:0;a:4:{s:8:"settings";a:45:{s:2:"id";s:4:"gal1";s:5:"width";s:3:"900";s:6:"height";s:3:"300";s:6:"jqcall";s:11:"window.load";s:16:"videogalleryskin";s:6:"normal";s:11:"displaymode";s:6:"normal";s:12:"menuposition";s:5:"right";s:8:"autoplay";s:2:"on";s:12:"autoplaynext";s:2:"on";s:8:"feedfrom";s:6:"normal";s:9:"scrollbar";s:3:"off";s:13:"cueFirstVideo";s:2:"on";s:10:"coverImage";s:81:"http://localhost/wordpress/wp-content/uploads/2012/04/target-businessman-copy.jpg";s:9:"defaultvg";s:5:"flash";s:17:"disableNonDefault";s:3:"off";s:7:"bgcolor";s:7:"#111111";s:6:"shadow";s:3:"off";s:12:"enableswitch";s:2:"on";s:4:"logo";s:0:"";s:8:"logoLink";s:0:"";s:11:"sharebutton";s:3:"off";s:12:"facebooklink";s:0:"";s:11:"twitterlink";s:0:"";s:14:"googlepluslink";s:0:"";s:11:"embedbutton";s:3:"off";s:16:"youtubefeed_user";s:0:"";s:20:"youtubefeed_playlist";s:0:"";s:21:"youtubefeed_maxvideos";s:2:"50";s:9:"sdquality";s:5:"small";s:9:"hdquality";s:5:"hd720";s:14:"defaultquality";s:2:"HD";s:14:"vimeofeed_user";s:0:"";s:15:"html5transition";s:7:"slideup";s:15:"html5responsive";s:3:"off";s:14:"html5designmiw";s:3:"275";s:14:"html5designmih";s:2:"76";s:13:"defaultvolume";s:0:"";s:9:"thumbnail";s:0:"";s:10:"windowmode";s:6:"opaque";s:18:"disabledescription";s:3:"off";s:17:"enabledeeplinking";s:3:"off";s:8:"hdButton";s:3:"off";s:20:"disablebigplaybutton";s:3:"off";s:23:"playerdesignonlybigplay";s:3:"off";s:15:"directurlaccess";s:3:"off";}i:0;a:8:{s:6:"source";s:11:"Hv7Jxi_wMq4";s:8:"thethumb";s:89:"http://localhost/wordpress/wp-content/plugins/dzs-videogallery/admin/img/defaultthumb.png";s:4:"type";s:7:"youtube";s:5:"title";s:0:"";s:11:"description";s:0:"";s:15:"menuDescription";s:0:"";s:14:"html5sourceogg";s:0:"";s:10:"audioimage";s:0:"";}i:1;a:8:{s:6:"source";s:11:"L7ANahx7aF0";s:8:"thethumb";s:89:"http://localhost/wordpress/wp-content/plugins/dzs-videogallery/admin/img/defaultthumb.png";s:4:"type";s:7:"youtube";s:5:"title";s:0:"";s:11:"description";s:0:"";s:15:"menuDescription";s:0:"";s:14:"html5sourceogg";s:0:"";s:10:"audioimage";s:0:"";}i:2;a:8:{s:6:"source";s:11:"7Ab7UOUtN_Q";s:8:"thethumb";s:89:"http://localhost/wordpress/wp-content/plugins/dzs-videogallery/admin/img/defaultthumb.png";s:4:"type";s:7:"youtube";s:5:"title";s:0:"";s:11:"description";s:0:"";s:15:"menuDescription";s:0:"";s:14:"html5sourceogg";s:0:"";s:10:"audioimage";s:0:"";}}}';
...
<div class="feedback"></div>';
        ...
        <div class="setting type_all">
            ...
            <select class="textinput styleme" name="0-settings-cueFirstVideo">
                <option>on</option>
                <option>off</option>
            </select>
        </div>
        <div class="setting">
            ...
            <input type="text" class="textinput" name="0-settings-coverImage" value=""/>' . $uploadbtnstring . '
        </div>
        <div class="setting type_all">
        ...
        <div class="setting type_all">
            <div class="setting-label">'.__('Disable Flash Gallery', 'dzsvg').'</div>
            <select class="textinput styleme" name="0-settings-disableNonDefault">
                <option>off</option>
                <option>on</option>
            </select>
        </div>
        ...
        <div class="setting">
            ...
            <input type="text" class="textinput" name="0-settings-logoLink" value=""/>
        </div>
	...
	<div class="setting">
        ...
        <div class="setting type_all">
            ...
            <select class="textinput styleme" name="0-settings-html5responsive">
                <option>off</option>
                <option>on</option>
            </select>
        </div>
...
<textarea class="textinput main-source  type_all" name="0-0-source" style="width:160px; height:23px;">Hv7Jxi_wMq4</textarea>' . $uploadbtnstring . '
        ...
        <div class="setting">
            ...
            <input class="textinput upload-prev main-thumb" name="0-0-thethumb" style="width:160px; height:23px;" value="' . $this->thepath . 'admin/img/defaultthumb.png"/>' . $uploadbtnstring . '
        </div>
        <div class="setting">
            <div class="setting-label">'.__('Type', 'dzsvg').':</div>
        ...
        <div class="setting">
            <div class="setting-label">'.__('Title', 'dzsvg').'</div>
            <input type="text" class="textinput" name="0-0-title"/>
        </div>
        <div class="setting">
            <div class="setting-label">'.__('Description', 'dzsvg').':</div>
        ...
        <div class="setting">
            <div class="setting-label">'.__('Audio Image', 'dzsvg').'</div>
            <div class="sidenote">only for audio type</div>
        ...
        <div class="setting">
            ...
            <div class="sidenote">if you host the video yourself, input here the mp4 / m4v source and have a file named the same with the .ogv 
            format in the same folder</div>
        ...
        add_action('wp_print_styles', array($this, 'handle_wp_print_styles'));
    ...
    function handle_wp_print_styles(){
        global $post;
        if($post){
    ...
    function handle_admin_head(){
        //echo 'ceva23';
        //siteurl : "'.site_url().'", 
        echo '<script>var zsvg_settings = { thepath : "'.$this->thepath.'" }; </script>';
    }
    ...
    function video_func($atts) {
        ...
        if (isset($atts['type']))
            $source.='&types=' . $atts['type'];
        if (isset($atts['audioimage']))
            $source.='&audioImages=' . $atts['audioimage'];
...
<div class="setting">
    <input type="submit" class="button-primary" name="submiter" value="Submit"/>
        ...
        if ($its['settings']['videogalleryskin'] == 'custom') {
            $skin = 'deploy/preview_allchars.swf';
            $html5vgskin = 'skin_custom';
        }
        $swfloc = $this->thepath . $skin;
...
,design_skin: "' . $html5vgskin . '"';
        ...
        if ($its['settings']['embedbutton'] == 'on') {
            $auxout = '<iframe src="' . $this->thepath . 'bridge.php?action=view&id=' . $its['settings']['id'] . '" width="' . $its['settings']['width'] . '" height="' . $its['settings']['height'] . '" style="overflow:hidden;" </iframe>';
...
';
    ...
    function handle_admin_menu() {
        ...
        if ($this->pluginmode == 'theme') {
            $zsvg_page = add_theme_page(__('DZS Video Gallery', 'dzsvg'), __('DZS Video Gallery', 'dzsvg'), $this->admin_capability, 'zsvg_menu', array($this, 'admin_page'));
        } else {
            $zsvg_page = add_options_page(__('DZS Video Gallery', 'dzsvg'), __('DZS Video Gallery', 'dzsvg'), $this->admin_capability, 'zsvg_menu', array($this, 'admin_page'));
        }
    }
    ...
    function admin_scripts() {
        ...
        wp_enqueue_script('jquery.form', $this->thepath . 'admin/dzsuploader/jquery.form.js');
    ...
    function front_scripts() {
        ...
        wp_enqueue_script('dzs.vplayer', $this->thepath . "videogallery/vplayer.js", $videogalleryscripts);
        wp_enqueue_script('dzs.flashhtml5main', $this->thepath . "videogallery/flashhtml5main.js", $videogalleryscripts);
...
<select name="usewordpressuploader" class="styleme">
<option>on</option>
<option>off</option>
</select>
<h5>Embed PrettyPhoto ?</h5>
<select name="embed_prettyphoto" class="styleme">
<option>on</option>
<option>off</option>
</select>
...
<div class="clear"></div>
            ...
            <a href="<?php echo $this->thepath; ?>readme/index.html" class="button-secondary action">Documentation</a>
            <a href="<?php echo $this->thepath; ?>deploy/designer/index.php" target="_blank" class="button-secondary action">Go to Designer Center</a>
            </div>
            ...
            <div class="block">
                <div class="extra-options">
                    <h3>Import</h3>
                    <!-- playlist: ADC18FE37410D250, user: digitalzoomstudio, vimeo: 5137664 -->
                    <input type="text" name="import_inputtext" id="import_inputtext" value="digitalzoomstudio"/>
                    <div class="sidenote">Import here feed from a YT Playlist, YT User Channel or Vimeo User Channel - you just have to enter the 
                        id of the playlist / user id in the box below and select the correct type from below</div>
            ...
            <div class="notes">
                ...
                <div class="sidenote">If neither of these are enabled, only normal feed will work. 
                    Contact your host provider on how to enable these services to use the YouTube User Channel 
                    or YouTube Playlist feed.
                </div>
            </div>
        ...
        <?php
        //$jsnewline = '\\' + "\n";
        echo "window.dzs_upload_path = '" . $this->thepath . "admin/dzsuploader/upload/';
";
        echo "window.dzs_phpfile_path = '" . $this->thepath . "admin/dzsuploader/upload.php';
";
...
';
    ...
    function post_importytplaylist() {
        ...
        $target_file = $this->httpprotocol . "http://gdata.youtube.com/feeds/api/playlists/" . $pd . "?alt=json&start-index=1&max-results=40";
        $ida = dzs_get_contents($target_file);
        $idar = json_decode($ida);
        //print_r($idar);
        if ($idar == false) {
    ...
    function post_importytuser() {
        ...
        //echo 'ceva';
            ...
            $target_file = "http://gdata.youtube.com/feeds/api/users/" . $pd . "/uploads?v=2&alt=jsonc";
        $ida = dzs_get_contents($target_file);
        $idar = json_decode($ida);
