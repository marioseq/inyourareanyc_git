...
class DesignerCenter{
    ...
    function __construct(){
        global $config;
        //print_r($config);
        $this->targetuser = $config['user'];
        $this->targetpass = $config['password'];
...
if (isset($_REQUEST['thedata'])) {
    ...
    foreach ($params as $key => $param) {
        ...
        if($key=='thumbs_bg'){
            $cssData .= '.videogallery.skin_custom .navigationThumb { background: ' . $param . '; } ';
        }
        if($key=='thumbs_borderc'){
            $cssData .= '.videogallery.skin_custom .navigationThumb { border-color: ' . $param . '; } ';
        }
        if($key=='thumbs_pic_w'){
        ...
        if($key=='thumbs_pic_x'){
            $cssData .= '.videogallery.skin_custom .imgblock { margin-left: ' . $param . 'px; } ';
        }
        if($key=='thumbs_pic_y'){
            $cssData .= '.videogallery.skin_custom .imgblock { margin-top: ' . $param . 'px; } ';
        }
        if($key=='thumbs_text_title_c'){
            $cssData .= '.videogallery.skin_custom .the-title { color: ' . $param . '; } ';
        }
        if($key=='thumbs_text_x'){
            $cssData .= '.videogallery.skin_custom .the-title { margin-left: ' . $param . '; } ';
        }
        if($key=='thumbs_text_y'){
            $cssData .= '.videogallery.skin_custom .the-title {  margin-top: ' . $param . '; } ';
        }
        if($key=='scr_h'){
            $cssData .= '.vplayer.skin_custom .scrub-bg {  height: ' . $param . 'px; } ';
            $cssData .= '.vplayer.skin_custom .scrub-buffer {  height: ' . $param . 'px; } ';
            $cssData .= '.vplayer.skin_custom .scrub {  height: ' . $param . 'px; } ';
        }
        if($key=='scr_bg'){
            $cssData .= '.vplayer.skin_custom .scrub-bg {  color: ' . $param . '; } ';
        }
        
        if($key=='scrl_bg'){
            $cssData .= '.vplayer.skin_custom .scrub-buffer {  color: ' . $param . '; } ';
        }
        if($key=='settings_controls_bg'){
            $cssData .= '.vplayer.skin_custom .background {  background-color: ' . $param . '; } ';
        }
        if($key=='settings_controls_bg_h'){
            $cssData .= '.vplayer.skin_custom .background {  height: ' . $param . 'px; } ';
        }
    }
    $cssFile = $config['csslocation'];
    $xh = fopen($cssFile, 'w') or die("can't open file");
