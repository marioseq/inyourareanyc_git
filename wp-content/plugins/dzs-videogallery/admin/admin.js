...
function sliders_ready(){
	...
	$('.slider-sliderexport').live('click', sliders_click_sliderexport)
	$('.slider-embed').live('click', sliders_click_sliderembed)
	...
	$('#importytplaylist').bind('click', extra_importytplaylist)
	$('#importytuser').bind('click', extra_importytuser)
	$('#importvimeouser').bind('click', extra_importvimeouser)
	...
	jQuery('.import-export-db-con .the-toggle').click(function(){
		...
		$cont.slideUp('slow');
		*/
		var cont_h = $cont.children('.the-content').height() + 50 + 19;
...
function sliders_click_sliderexport(){
    ...
    //console.log(_t, ind);
    tb_show('Slide Editor', zsvg_settings.thepath + 'admin/sliderexport.php?KeepThis=true&width=400&height=200&slidernr=' + ind + '&slidername=' + sname + '&TB_iframe=true');
    return false;
}
function sliders_click_sliderembed(){
    ...
    jQuery('.saveconfirmer').html('use this shortcode for embedding: [videogallery id="' + sname + '"]');
...
var $ = jQuery.noConflict();
	$('.main_sliders').children('tbody').append('<tr class="slider-in-table"><td>default</td><td class="button_view"><strong><a href="#" class="slider-action slider-edit">Edit</a></strong></td><td class="button_view"><strong><a href="#" class="slider-action slider-embed">Embed</a></strong></td><td class="button_view"><strong><a href="#" class="slider-action slider-sliderexport">Export</a></strong></td><td class="button_view"><strong><a href="#" class="slider-action slider-duplicate">Duplicate</a></strong></td><td class="button_view"><strong><a href="#" class="slider-action slider-delete">Delete</a></strong></td></tr>')
